...
//CartFragment.conformOrder.setOnClickListener(new View.OnClickListener() {
//    @Override
//    public void onClick(View v) {
//
//    //    final HashMap<String,Object>cartMap=new HashMap<>();
//        //Toast.makeText(context, modal.getItemPrice(), Toast.LENGTH_SHORT).show();
//    }
//});
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            conformOrder=itemView.findViewById(R.id.conformOrder);
